...
public class GetFromWsFunction implements JavaFunction {
	...
	protected Map<String, Object> parseXml(String contentBody) {
		...
		Map<String, Object> filledMap = fillMap(detectCollections, contentBody);
		return filledMap;
	}
	...
	/**
	 * Trata de adivinar la estructura del archivo XML para generar una estructura anidada dadas rutas planas.
	 * Esto implica que las siguientes rutas:
	 * 	uno.dos.tres.cuatro
	 * 	uno.dos.tres.cinco
	 * 	uno.dos.cuatro.cinco
	 * 	uno.dos.cuatro.cinco
	 * Se conviertan en las siguientes rutas:
	 * 	uno.dos.tres[].cuatro
	 * 	uno.dos.tres[].cinco
	 * 	uno.dos.cuatro.cinco[]
	 * 
